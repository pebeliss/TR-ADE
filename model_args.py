...
def getArgs(argv=None):
    ...
    parser.add_argument('--data_path',type=str, default='./test_data', help='Data folder')
    ...
    parser.add_argument('--c_sigma_initializer', type=str, default='glorot', help='Initializer for cluster variance.')
    parser.add_argument('--nn_layers', type=list, default=[64,32,16], help='Hidden layers of the encoder and reverse decoder.')
